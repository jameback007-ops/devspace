...
const migrations: Migration[] = [
  ...
  {
    version: 17,
    name: "durable-oauth-authorization-codes",
    up: migrateDurableOAuthAuthorizationCodes,
  },
];
...
function migrateDurableOAuthAuthorizationCodes(sqlite: Database.Database): void {
  sqlite.exec(`
